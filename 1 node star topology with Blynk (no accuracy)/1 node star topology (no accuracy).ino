...
void sendSensor() {
  ...
  /*****************************  MQ CAlibration ********************************************/ 
    ...
    //LOOP
    constexpr uint32_t down_s = 5; //ORIG: 210
    ...
    constexpr uint32_t duty_s = 5; //ORIG: 30
    ...
    sds011.on_query_data_auto_completed([](int n) {
        ...
        if (sds011.filter_data(n, pm25_table, pm10_table, pm25, pm10) &&
            ...
            Blynk.virtualWrite(V4, float(pm10)/10);
            Serial.println("PM2.5: " + String(float(pm25)/10) + " ug/m^3");
            Blynk.virtualWrite(V5, float(pm25)/10);
        }
