...
const int packetSize = 20; // each packet has 20 bytes kasi 4 bytes each air quality parameter (temp, humi, CO, pm2.5, pm10) 
const int numPackets = 12;  // Total number of packets to send, 12 per hour kasi 5 minutes each sensor measurement
...
void loop_DHT22_MQ135(){
  // delay(270000); // 4 minute and 30 seconds before measuring
  delay(30000); // 30 seconds per measurement
